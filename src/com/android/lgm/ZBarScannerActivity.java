...
import com.android.lgm.views.CameraPreview;
import com.android.lgm.views.FlashingLine;
...
public class ZBarScannerActivity extends Activity implements
	...
	private FlashingLine mFlasingLine;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FrameLayout fram = new FrameLayout(this);
		mFlasingLine = new FlashingLine(this);
		fram.addView(mPreview);
		fram.addView(mFlasingLine);
		setContentView(fram);				
	}
